...
if not cfg.test:
    ...
    # print("cfg.val_split:",cfg.val_split)
    # print("cfg.train_split:",cfg.train_split)
    ...
    data_loading_time = time.time() - start_time  # 计算数据加载时间
    print("Data loading time:", data_loading_time, "seconds")
    ...
    print("cfg.check_val_every_n_epoch:",cfg.check_val_every_n_epoch)
    start_time = time.time()  # 记录开始时间
    trainer.fit(net, train_loader, val_loader)
    training_time = time.time() - start_time  # 计算训练时间
    print("Training time:", training_time, "seconds")
    print("TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTRRRRRRRRRRRRRRRRRRR")
else:
    test_data = get_dataset(cfg, type='test', split=cfg.test_split)
    print("cfg.test_split:",cfg.test_split)
    ...
    print("TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE")
